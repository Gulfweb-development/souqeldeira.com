<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.abouts')</x-slot>
    <x-slot name="title">@lang('app.abouts')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.abouts')</li>
    </x-slot>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('about_text_create'))
                        <a href="{{ route('admin.about.create') }}" class="btn btn-primary create-btn"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $abouts->count() }}
                                    @lang('app.of') {{ $abouts->total() }} @lang('app.entries')</div>
                            </div>
