<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.contacts')</x-slot>
    <x-slot name="title">@lang('app.contacts')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.contacts')</li>
    </x-slot>
    <div class="row">
                                    ...
                                    <tbody>
                                        @forelse ($contacts as $contact)
                                            <tr role="row" class="odd">
                                                <td class="table-id">{{ $contact->id }}</td>
                                                ...
                                                <td>
                                                    <div class="actions">
                                                        ...
                                                        @endif
                                                        {{-- <a href="{{ route('admin.contact.edit',[$contact->id]) }}" class="btn bg-gradient-info btn-sm edit-btn"
                                                title="@lang('app.edit')">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $contacts->count() }}
                                    @lang('app.of') {{ $contacts->total() }} @lang('app.entries')</div>
                            </div>
