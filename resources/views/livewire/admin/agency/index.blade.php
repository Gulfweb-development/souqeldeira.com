<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.agencies')</x-slot>
    <x-slot name="title">@lang('app.agencies')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.agencies')</li>
    </x-slot>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('agency_create'))
                        <a href="{{ route('admin.agency.create') }}" class="btn btn-primary create-btn"
                                    ...
                                    <tbody>
                                        @forelse ($agencies as $agency)
                                            <tr role="row" class="odd">
                                                <td class="table-id">{{ $agency->id }}</td>
                                                <td><img src="{{ $agency->getFile() }}" alt="image"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $agencies->count() }}
                                    @lang('app.of') {{ $agencies->total() }} @lang('app.entries')</div>
                            </div>
