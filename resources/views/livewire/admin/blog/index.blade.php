<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.blogs')</x-slot>
    <x-slot name="title">@lang('app.blogs')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.blogs')</li>
    </x-slot>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('blog_create'))
                        <a href="{{ route('admin.blog.create') }}" class="btn btn-primary create-btn"
                                    ...
                                    <tbody>
                                        @forelse ($blogs as $blog)
                                            <tr role="row" class="odd">
                                                <td class="table-id">{{ $blog->id }}</td>
                                                <td><img src="{{ $blog->getFile() }}" alt="image"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $blogs->count() }}
                                    @lang('app.of') {{ $blogs->total() }} @lang('app.entries')</div>
                            </div>
