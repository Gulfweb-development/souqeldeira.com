<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.building_types')</x-slot>
    <x-slot name="title">@lang('app.building_types')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.building_types')</li>
    </x-slot>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('building_type_create'))
                        <a href="{{ route('admin.buildingtype.create') }}" class="btn btn-primary create-btn"
                                    ...
                                    <tbody>
                                        @forelse ($buildingTypes as $buildingType)
                                            <tr role="row" class="odd">
                                                <td class="table-id">{{ $buildingType->id }}</td>
                                                <td>{{ $buildingType->translate('name') }}</td>
                                                <td>
                                                    <div class="actions">

                                                        @if (permationTo('building_type_view'))
                                                            <a href="{{ route('admin.buildingtype.show', [$buildingType->id]) }}"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $buildingTypes->count() }}
                                    @lang('app.of') {{ $buildingTypes->total() }} @lang('app.entries')</div>
                            </div>
