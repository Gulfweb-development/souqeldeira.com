<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.governorates')</x-slot>
    <x-slot name="title">@lang('app.governorates')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active">@lang('app.governorates')</li>
    </x-slot>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('governorate_create'))
                        <a href="{{ route('admin.governorate.create') }}" class="btn btn-primary create-btn"
                                    ...
                                    <tbody>
                                        @forelse ($governorates as $governorate)
                                            <tr role="row" class="odd">
                                                <td class="table-id">{{ $governorate->id }}</td>
                                                <td><img src="{{ $governorate->getFile() }}" alt="image"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $governorates->count() }}
                                    @lang('app.of') {{ $governorates->total() }} @lang('app.entries')</div>
                            </div>
