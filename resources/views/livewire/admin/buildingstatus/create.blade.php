<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.building_status') | @lang('app.create')</x-slot>
    <x-slot name="title">@lang('app.building_status') | @lang('app.create')</x-slot>
