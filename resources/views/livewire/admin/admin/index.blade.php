<div>
    <x-slot name="meta_title">@lang('app.dashboard') | @lang('app.admins')</x-slot>
    <x-slot name="title">@lang('app.admins')</x-slot>
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    @if (permationTo('admin_create'))
                        <a href="{{ route('admin.admin.create') }}" class="btn btn-primary create-btn"
                                    ...
                                    <tbody>
                                        @forelse ($admins as $admin)
                                            <tr role="row" class="odd">
                                                ...
                                                <td><img src="{{ $admin->getFile() }}" alt="image"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    ...
                                    {{ $admins->count() }}
                                    @lang('app.of') {{ $admins->total() }} @lang('app.entries')</div>
                            </div>
