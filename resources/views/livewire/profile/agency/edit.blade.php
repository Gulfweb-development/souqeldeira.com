<div>
    <x-slot name="meta_title">@lang('app.agencies') | @lang('app.edit')</x-slot>
    <div class="section-body listing-table">
        <div class="widget-boxed-header">
            <h4>@lang('app.agencies') | @lang('app.edit')</h4>
        </div>
  ...
  <hr>
            ...
            " x-on:dragover.prevent="dropingFile = true" x-on:dragleave.prevent="dropingFile = false">
                ...
                <hr>
                <input type="button" name="sendmessage" class="multiple-send-message" value="@lang('app.update')"
