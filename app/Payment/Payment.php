...
class Payment extends Core
{
    ...
    private $total                  = 0;
    private $lang                   = "en";
    private $DisplayCurrencyIso     = "kwd";
    private $CallBackUrl            = 'http://test-payment.bugaia.net/api/v1/payment/success';
    private $ErrorUrl               = 'http://test-payment.bugaia.net/api/v1/payment/error';
    ...
    public function setCustomer($customer = []) {
        $data = [
            "CustomerName"      =>  (array_key_exists('name',$customer)) ? $customer['name'] : 'dev.bugaia',
            ...
            "CustomerEmail"     =>  (array_key_exists('email',$customer)) ? $customer['email'] : 'info@bugaia.net',
        ];
        $this->customer = $data;
        return $this;
    }
    ...
    public function setAddress($address = []) {
        $data = [
            "Block"                 => (array_key_exists('block',$address)) ? $address['block'] : 'BUGaia',
            "Street"                => (array_key_exists('street',$address)) ? $address['street'] : 'BUGaia',
            "HouseBuildingNo"       => (array_key_exists('building',$address)) ? $address['building'] : 'BUGaia',
            "Address"               => (array_key_exists('address',$address)) ? $address['address'] : 'BUGaia',
            "AddressInstructions"   => (array_key_exists('instructions',$address)) ? $address['instructions'] : 'BUGaia',
        ];
        $this->address = $data;
        return $this;
    }
