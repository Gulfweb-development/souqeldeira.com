...
class Edit extends Component
{
    ...
    {
        $position = Position::query()->where('user_id' , auth()->id() )->find($id);
        if ( blank($position) )
            abort(404);
    ...
    public function edit()
    {
        ...
        return redirect()->route('profile.positions.index')->with('success', trans('app.data_updated'));;
    }

    public function render()
    {
        return view('livewire.profile.positions.edit')->layout(PROFILE_LAYOUT);
    }
}
